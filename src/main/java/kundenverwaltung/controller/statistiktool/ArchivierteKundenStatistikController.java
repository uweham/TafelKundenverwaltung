...
public class ArchivierteKundenStatistikController extends StatistiktoolMasterClassController<ArchivierteKundenStatistikController>
{
	/**
     */
	@FXML
	public void initialize()
	{
	  initRange();
	  initVerteilstelle();	
      loadheader("Tafel Statistik - Angemeldet als :","Statistik:Kunden");
    ...
    public String getCurrentSQLQuery()
    {
       ...
       String query = statistikDAO. buildSqlQueryArchivierteKundenstatistik(verteilstellenId,rangeId);
